...
export function Chat() {
  ...
  return (
    <motion.main className="w-full h-screen flex flex-col justify-start items-center overflow-y-scroll scrollbar" initial={{x: 300}} animate={{x: 0}} exit={{x: 300}} transition={{duration: 0.3}}>
      ...
      <section className="flex flex-col gap-2 w-full p-2 mb-16 h-full">
