...
export function Picture() {
  ...
  return (
    <motion.main initial={{y: 300}} animate={{y: 0}} exit={{y: 300}} transition={{duration: 0.6}} className="flex flex-col w-full p-2 items-center justify-start gap-2 h-screen overflow-y-scroll scrollbar">
