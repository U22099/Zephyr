...
export function Header() {
  return (
    <main className="sticky top-0 left-0 w-full grid grid-cols-10 grid-gap-2 backdrop-blur-sm relative pt-2 pb-4 border-b z-10">
      <div className="col-span-1 p-2 rounded-full bg-primary flex justify-center items-center w-6 h-6">
        <RiCheckDoubleLine className="text-xl fill-white"/>
      </div>
      <h3 className="col-span-6 w-full flex justify-center items-center text-center font-bold">Chats</h3>
      <div className="col-span-1 p-2 rounded-full bg-gray-700 flex justify-center items-center w-6 h-6">
