...
export function Navigation({nav, setNav}){
  return(
    <motion.main initial={{x: -300}} animate={{x: 0}} transition={{duration: 1}} exit={{x: -300}} className="fixed bottom-0 flex justify-around py-1 bg-transparent backdrop-blur-md p-2 w-full py-2 border-t">
